        ...
        if(count _sPos > 1 && {_distance < 15}) then {
            _text = switch (true) do {
                ...
                case (!isNil {(_x getVariable "rank")}): {format["<img image='%1' size='1'></img> %2",switch ((_x getVariable "rank")) do {
                    ...
                    case 7: {"\a3\ui_f\data\gui\cfg\Ranks\corporal_gs.paa"};
					...
					case 16: {"\a3\ui_f\data\gui\cfg\Ranks\captain_gs.paa"};
					case 17: {"\a3\ui_f\data\gui\cfg\Ranks\major_gs.paa"};
					case 18: {"\a3\ui_f\data\gui\cfg\Ranks\general_gs.paa"};
					case 19: {"\a3\ui_f\data\gui\cfg\Ranks\general_gs.paa"};
					case 20: {"\a3\ui_f\data\gui\cfg\Ranks\general_gs.paa"};
					case 21: {"\a3\ui_f\data\gui\cfg\Ranks\general_gs.paa"};
