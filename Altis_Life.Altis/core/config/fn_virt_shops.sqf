...
switch (_shop) do
{
	case "market": {["Markt",["water","rabbit","apple","storagebig","storagesmall","bottledbeer","bottledwhiskey","redgull","battery","tbacon","lockpick","pickaxe","zipties","peach","boltcutter","blastingcharge","schokolade","cola"]]};
	...
	case "diamond": {["Diamond Dealer",["diamond","diamondc","silberu","silberp","goldu","goldp"]]};
	case "salt": {["Salt Dealer",["salt_r"]]};
	case "cop": {["Cop Item Shop",["donuts","coffee","spikeStrip","mauer","battery","painkillers","tbacon","redgull","defusekit"]]};
