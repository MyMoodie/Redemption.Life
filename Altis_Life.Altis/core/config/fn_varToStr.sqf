...
switch (_var) do
{
	...
	case "life_inv_personalausweis": {"Personalausweis"};
	case "life_inv_reisepass": {"Reisepass"};
	...
	case "license_civ_personalausweis": {"Personalausweis"};
	case "license_civ_reisepass": {"Reisepass"};
	case "license_civ_taxischein": {"Taxischein"};
