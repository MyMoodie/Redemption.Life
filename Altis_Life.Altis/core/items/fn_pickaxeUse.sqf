...
hint "Was eine harte Arbeit !";
player say3D "mining"; //Damit hört nur der Spieler den abgespielten Sound
sleep 3;
...
//Mine check
if(_mine == "") exitWith {hint "Sie sind nicht in der Naehe von einem Bergwerk!"};
...
if(([true,_mine,_diff] call life_fnc_handleInv)) then
{
	...
	titleText[format["Du hast %2 %1",_itemName,_diff],"PLAIN"];
};
