...
_chance = random(100);
if(_chance >= 85) then { hint "Die Polizei wurde benachrichtig!"; [[1,format["Ein Geldautomat wird aufgebrochen!", _shop]],"life_fnc_broadcast",west,false] spawn life_fnc_MP; };
