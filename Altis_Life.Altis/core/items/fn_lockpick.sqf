...
if(!_isVehicle) then {
	...
	[[_curTarget],"life_fnc_CarAlarmSound",nil,true] spawn life_fnc_MP;
        ...
        [[0,format["%1 wurde bei einem versuchten Autodiebstahl gesehen.",player getVariable["realname",name player]]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
        titleText["Dein Dietrich ist abgebrochen.","PLAIN"];
    };
};