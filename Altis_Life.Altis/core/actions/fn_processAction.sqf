...
_itemInfo = switch (_type) do
{
	...
	case "salt": {["salt","salt_r",450,"Verarbeite Sand"]};
	case "cocaine": {["cocaine","cocainep",1500,"Verarbeite Cocaine"]};
	...
	case "grapes": {["grapes","wine",250,"Verarbeite Trauben zu Wein"]};
	case "moonshine": {["yeast","moonshine",250,"Moonshining",true,"mash"]};//new
	case "meth": {["methu","methp",5000,"Koche Meth"]};
	case "bottledshine": {["moonshine","bottledshine",500,"Fülle Moonshine ab",true,"bottles"]};//new
	case "whiskey": {["yeast","whiskey",1000,"Gären Whiskey",true,"rye"]};//new
	case "beer": {["yeast","beerp",1500,"Braue Bier",true,"hops"]};//new
	case "bottledbeer": {["beerp","bottledbeer",500,"Fülle Bier ab",true,"bottles"]};//new
	case "bottledwhiskey": {["whiskey","bottledwhiskey",500,"Fülle Whiskey ab",true,"bottles"]};//new
	...
	case "gold": {["goldu","goldp",500,"Rohgold verarbeiten"]};
	default {[]};
};
