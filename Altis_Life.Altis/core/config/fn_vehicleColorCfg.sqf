...
switch (_vehicle) do
{
	...
	case "B_MRAP_01_F":
	{
		...
		_ret = 
		[
			[_path + "_sek__hnt_1_f.paa","cop",_path + "_sek__hnt_1_h.paa"],
			[_path + "donator_hunter_front.jpg","civ",_path + "donator_hunter_hinten.jpg"],
			[_path + "_pol__hnt_1_f.paa","cop",_path + "_pol__hnt_1_h.paa"]
		];
	};
	...
	case "B_MRAP_01_hmg_F":
	{
		_ret = 
		[
			["skins\car\_sek__hnt_1_f.paa","cop","skins\car\_sek__hnt_1_h.paa"]
		];
	};
	...
	case "B_Heli_Transport_01_F":
	{
		...
		_ret =
		[
			[_path + "_pol__ght_1_f.paa","cop",_path + "_pol__ght_1_h.paa"]
		];
	};
