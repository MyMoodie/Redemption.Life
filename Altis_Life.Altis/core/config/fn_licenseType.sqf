...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "personalausweis": {_var = "license_civ_personalausweis"};
			case "reisepass": {_var = "license_civ_reisepass"};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_personalausweis": {_var = "personalausweis"};
			case "license_civ_reisepass": {_var = "reisepass"};
